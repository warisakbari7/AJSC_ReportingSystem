...
<div class="container ">
    <div class="row">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" action="{{route('reporter-report.detailsreports.store',[$report])}}" method="POST" enctype="multipart/form-data" id="form_report">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" class="form-control" placeholder="عنوان..." value="{{old('title')}}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" id="content" cols="30" rows="5" class="form-control" placeholder="محتوا">{{old('content')}}</textarea>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{route('reporterreport.show',$report)}}" class="btn text-white" style="background: #51131c !important;">منصرف</a>
