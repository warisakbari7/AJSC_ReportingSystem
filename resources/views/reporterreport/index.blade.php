                ...
                <tbody>
                  @forelse ( $reports as $report)
                      <tr>
                          ...
                          <td class="text-truncate" style="max-width:100px;" >خودشما</td>
                          <td>{{$report->created_at->format('d/m/Y')}}</td>
                          <td>{{$report->user->zone?->name}} </td>
                          <td style="width:7% !important;"><a href="{{route('reporterreport.show',$report->id)}}"> <i class="fa fa-eye text-gray" ></i></a> </td>
