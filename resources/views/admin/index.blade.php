            ...
            <div class="card">
              <div class="card-header">
                <div class="d-flex justify-content-between">
                  @csrf
                    <h5 class="text-md">فهرست کاربر ها</h5>
                    <a href="{{route('admin.create')}}" class="btn text-white" style="background: #51131c !important;">اضافه کردن کاربر</a>
                </div>
              </div>
              <!-- /.card-header -->
                  ...
                  <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('admin.edit',$user->id)}}"><i class="fa fa-edit text-sm text-gray"></i></a></td>
                        </tr>
                        @empty
                            <tr>
...
<div class="modal fade" id="deleteModal">
  <div class="modal-dialog modal-dialog-centered">
    ...
    <form action="{{route('admin.destroy',0)}}" method="post" enctype="multipart/form-data" id="deleteform">
      <!-- Modal Header -->
      @method('delete')
      @csrf
