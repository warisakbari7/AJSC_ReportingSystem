...
<div class="container ">
    <div class="row">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" action="{{route('reporterreport.store')}}" method="POST" enctype="multipart/form-data" id="form_report">
                @csrf
            <div class="card-body">
                ...
                <div class="w-100">
                  ...
                  <div class="form-group">
                    <label for="first">تعداد نشست های دادخواهی بامسوولان حکومتی باذکرنام و مقام.</label>
                ...
                <div class="form-group">
                    <label for="second">تعدادجلسات دادخواهی با رسانه ها باذکرنام رسانه.</label>
                ...
                <div class="form-group">
                    <label for="third">آیاکدام موردخاص برای دادخواهی شامل برنامه تان است؟<br>اگر بلی موارد مذکور رابانام ولایت آن بنویسید.</label>
                ...
                <div class="form-group">
                    <label for="fourth">آیاپیشرفت قابل ملاحظه درموردخاص که برای آن دادخواهی کردید صورت گرفته است؟</label>
                ...
                <div class="form-group">
                    <label for="fifth">درجریان گزارش دهی آیاکدام دست آوردخاصی داشته اید؟</label>
...
<script src="{{asset('js/reporterreport/formsubmition.js')}}"></script>
@endpush
@push('styles')
