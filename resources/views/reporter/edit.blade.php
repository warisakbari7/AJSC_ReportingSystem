    ...
    <div class="row  py-3">
        <div class="col-12">
            <div class="card card-primary">
                ...
                <form action="{{route('reporter.update',$user->id)}}" method="post" enctype="multipart/form-data">
                @method('put')
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="zone">زون مربوطه</label>
                            <select name="zone" id="zone" class="form-control">
                                <option selected hidden disabled>انتخاب زون</option>
                            ...
                            @if($errors->has('zone'))
                                <p class="text-danger mr-2">{{$errors->first('zone')}}</p>
                            @endif
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{route('reporter.index')}}" class="btn text-white" style="background: #51131c !important;">منصرف</a>
                    </div>
                </form>
            </div>
        <!-- /.card -->
