        ...
        <div class="card">
          <div class="card-header">
            <div class="d-flex justify-content-between">
                <h5 class="text-md">نتیجه جستجو</h5>
...
<form action="http://127.0.0.1:8000/reporter/0" method="post" enctype="multipart/form-data" id="deleteform">
  <!-- Modal Header -->
  <input type="hidden" name="_method" value="delete">      <input type="hidden" name="_token" value="quPevmsFssL9FHyB2z9Zc942i7BJCyPKr7HQL83m">      <div class="modal-header">
